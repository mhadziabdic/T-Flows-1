!==============================================================================!
  subroutine Backup_Mod_Load(fld, time_step, time_step_stat, comp_time, backup)
!------------------------------------------------------------------------------!
...
!---------------------------------[Arguments]----------------------------------!
  ...
  real                     :: comp_time       ! total time of running
...
!==============================================================================!
  ...
  call Backup_Mod_Read_Real(fh, d, vc, 'time_comp', comp_time)
